...
class Pessoa {
    ...
    public static function getConnection() {
        if (empty(self::$conn)) {
            ...
            self::$conn = new PDO("pgsql:dbname={$name};user={$user};host={$host};password={$pass}");
    ...
    public static function find($id) {
        ...
        // prepare() e : bloqueia SQL injection (permite apenas valores)
